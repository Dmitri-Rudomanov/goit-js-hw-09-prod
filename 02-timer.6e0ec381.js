...
(0, _flatpickr.default)(refs.timepicker, options);
...
class Timer {
  ...
  convertMs(ms) {
    ...
    const days = this.addLeadingZero(Math.floor(ms / day)); // Remaining hours

    const hours = this.addLeadingZero(Math.floor(ms % day / hour)); // Remaining minutes

    const minutes = this.addLeadingZero(Math.floor(ms % day % hour / minute)); // Remaining seconds
...
},{"notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.2.2.min.js","flatpickr":"../node_modules/flatpickr/dist/esm/index.js","flatpickr/dist/flatpickr.min.css":"../node_modules/flatpickr/dist/flatpickr.min.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
